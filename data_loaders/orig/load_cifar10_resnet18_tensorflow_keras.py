...
def load_cifar10_res_net18_classifier(root: Path, force_preprocess: bool = False):
    ...
    """
#TODO: modificare linieli 35 si 41;
 
    def build_res_net18_model():
        # Load the ResNet18 pre-trained model
        resnet18, preprocess_input = Classifiers.get('resnet18')
        base_model = resnet18((224, 224, 28), weights='imagenet')
    ...
    def get_cifar10_data_loaders():
        ...
        (x_train_cifar10, y_train_cifar10), (x_test_cifar10, y_test_cifar10) = tf.keras.datasets.mnist.load_data()
